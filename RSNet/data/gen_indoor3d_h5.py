...
output_dir = 'indoor3d_sem_seg_hdf5_data_{}_{}m_{}s_{}'.format(args.area, block_size, stride, split)
...
for i, data_label_filename in enumerate(data_label_files):
    ...
    data, label = indoor3d_util.room2blocks_wrapper_normalized(data_label_filename, NUM_POINT, block_size=block_size,
